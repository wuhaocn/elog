...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -tags "linux" -type sockops_event bpf sockops.c -- -I../../headers
...
func main() {
	...
	rd, err := ringbuf.NewReader(objs.bpfMaps.SockopsEvents)
	if err != nil {
